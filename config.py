...
OWNER_ID = int(getenv("OWNER_ID", 5872494092))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/wantedhackerofficiall")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/wantedhackerofficiall")
